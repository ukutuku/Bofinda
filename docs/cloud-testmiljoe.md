...
| `scripts/cloud/kontrol.sh` | Browserkontrol: DOM, skærmbilleder, analytics. |
...
Deterministisk: én fast frø (`20260908`) driver hele sættet, så to
kørsler giver bit for bit det samme.

264 boliger → **144+ kort efter gruppering**, altså mindst tre sider à
48. Det indeholder med vilje:
