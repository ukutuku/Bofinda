...
// Samme stramme mål som saa.mjs og tjek.ts: loopback OG port 55432 OG
// databasen bofinda_test. Manglede navnet foer, saa en base ved siden af
// paa samme port ville have faaet skemaet skrevet ned over sig.
const u = new URL(url)
